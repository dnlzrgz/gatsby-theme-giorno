...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      type: "number",
      description: "Minimum number of characters required that the user should enter.",
    ...
    },
    {
      ...
      title: "Required",
      type: "boolean",
      description: "Select if textarea is required before allowing the form to be submitted.",
    },
  ],
  preview: {
    select: {
