export default {
	...
	fields: [
		...
		},
		{
			...
			type: 'plainContent',
			description:
				'Site meta description for SEO. This text will show up as part of a search result entry.',
			validation: (Rule) => Rule.required(),
		},
		{
			name: 'siteURL',
		...
		},
		{
			...
			type: 'image',
			description:
				'Image to display by default when your project is being shared in social media.',
		},
		{
			name: 'navbar',
